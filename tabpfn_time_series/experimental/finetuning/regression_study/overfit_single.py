...
def main():
    ...
    parser.add_argument(
        ...
        help="The space to use for the loss function.",
    )
    parser.add_argument(
    ...
    N_ENSEMBLE_CONFIGURATIONS = args.n_estimators
    RANDOM_SEED = 42
    ...
    meta_X_train = meta_X_val
    meta_y_train = meta_y_val
    ...
    for epoch in range(EPOCHS):
        ...
        for i, data_batch in enumerate(pbar):
            ...
            if args.loss_space == "standardized":
                loss_fn = bardist[0]
                y_target = y_test_std[0]
            elif args.loss_space == "raw":
                loss_fn = norm_bardist[0]
                y_target = y_test_raw[0]
            else:
                raise ValueError(f"Unknown loss space: {args.loss_space}")
